...
class MainWindow(QMainWindow):
    ...
    def refresh_file_list(self, dir_path):
        self.treeView.setModel(ProcessModel(self.treeView, scan(str(dir_path))))
    ...
    def save_and_load_novel_info(self, current, previous):
        ...
        if FileUtils.exists(previous_novel):
        ...
        if FileUtils.exists(selected_novel):
            ...
            if not FileUtils.exists(portrait_file):
